...
export default function TopBar(){
    ...
    return(
        <Card intensity={900} blur={40} color='purple' noPadding className={`w-full flex gap-[1rem] mb-[1rem] p-[1rem] items-center rounded-xl ${isMobile ? 'justify-center' : 'justify-end'}`}>
