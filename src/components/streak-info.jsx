...
import { Card, Avatar, SectionName } from 'azeriand-library'
...
export default function StreakInfo({className, ...cardProps}){
    ...
    const { currentStreak, defaultUserName } = useContext(SettingsContext);
    ...
    return(
        <Card className='flex items-center gap-x-[1.5rem] p-[1rem]' {...cardProps} style={{...cardProps.style}} appearance='glass'>
            ...
            <div>
                <p className='m-0 p-0 font-bold text-start text-purple-100'>{defaultUserName}</p>
