...
export default function Input({type, value, disabled, placeholder, size, maxLength, onChange, iconPosition='left', icon, className, ...cardProps}){
    ...
    const inputClassName=`flex text-center justify-center items-center border-none bg-none py-[0.5rem] px-[1rem] m-0 ${className}`

    return(
    <div className={classnames}>
        <Card className='flex text-center justify-center items-center rounded-md' noBlur noPadding {...cardProps} style={inputStyle}>
